...
**在AIGC时代，AI Agent是一个非常重要的方向，也是AIGC技术发展的大势所趋。**

那么，AI Agent到底是什么呢？

首先给大家讲解一下非AI Agent（Non-Agent），即常规AIGC大模型的运行逻辑，然后我们就能从两者的对比中恍然大悟。
...
当前AI Agent的核心还是基于LLM大模型+深度的Prompts工程，**未来AI Agent会有更多内涵，比如：**
...
接下来，举一个生动形象的例子，让我们通俗易懂的领会Function Call的整个流程。
...
这里总结了当前AI Agent中的主流核心大模型，随着AI Agent领域的不断发展，相信未来会有更多核心大模型出现：
1. Claude-4.x-sonnet
2. DeepSeek-R1/V3.x
3. gemini-3系列
4. qwen3.x系列
...
接下来，举一个详细的例子，让大家更加通俗易懂的理解三种Prompt是如何拼接用户问题，并作为上下文输入给大模型的：
...
AI Agent是AI Workflow的进化版，AI Agent和AI Workflow在广义上都可以称为Agent。
...
## 22. 目前主流的AI-Agent框架有哪些？

当前主流的 AI Agent 框架生态丰富，各有侧重。下面这个表格中汇总了几个备受关注框架的核心特点。
