...
type ReviewAppealInfo struct {
	...
	AppealID  int64     `gorm:"column:appeal_id;comment:id" json:"appeal_id"`                   // id
	...
	Status    int32     `gorm:"column:status;not null;default:10;comment:102030" json:"status"` // 102030
