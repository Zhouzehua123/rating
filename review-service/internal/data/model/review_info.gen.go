...
type ReviewInfo struct {
	...
	Status        int32      `gorm:"column:status;not null;default:10;comment:10203040" json:"status"` // 10203040
	IsDefault     int32      `gorm:"column:is_default;not null" json:"is_default"`
	HasReply      int32      `gorm:"column:has_reply;not null;comment:01" json:"has_reply"` // 01
	...
	GoodsSnapshot string     `gorm:"column:goods_snapshot;not null" json:"goods_snapshot"`
