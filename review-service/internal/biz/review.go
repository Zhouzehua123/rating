...
type MyReviewInfo struct {
	...
	Status       int32  `json:"status,string"` // 10203040
	IsDefault    int32  `json:"is_default,string"`
	HasReply     int32  `json:"has_reply,string"` // 01
	IsDel        int32  `json:"is_del,string"`
...
//json.Unmarshal的时候会自动调用这个方法
func (t *MyTime) UnmarshalJSON(data []byte) error {
	//data="\"2023-06-10T15:04:05\""
